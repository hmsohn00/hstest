...
from brevettiai.data.sample_integrity import SamplePurpose
...
class Hstest(Job):
    ...
    def train(self):
        ...
        full_set = SamplePurpose().assign(full_set, id_path=self.artifact_path("sample_identification.csv"),
                                          purpose='train', remainder='test')

        # divide samples into train/test set
        train_set = full_set.loc[full_set.purpose == 'train']
        test_set = full_set.loc[full_set.purpose == 'test']
